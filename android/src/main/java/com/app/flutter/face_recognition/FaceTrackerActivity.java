...
import com.app.flutter.face_recognition.ui.camera.CameraSourcePreview;
import com.app.flutter.face_recognition.ui.camera.GraphicOverlay;
...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    Point leftMouthCorner = null;
    Point rightMouthCorner = null;
    Point MouthBase = null;
    ...
    // Activity Methods
    //==============================================================================================
    private final double OPEN_MOUTH = 0.98;
    ...
    public static String getImgBase64(){
        return FaceTrackerActivity.imgBase64;
    }

    public static void setImgBase64(String img){
        FaceTrackerActivity.imgBase64 = img;
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        pd = new ProgressDialog(FaceTrackerActivity.this);
...
*/
    ...
    public void setImageViewPicture(Bitmap bmpPicture) {
        ...
        bmpPicture.compress(Bitmap.CompressFormat.PNG, 100, byteArrayOutputStream);
        byte[] byteArray = byteArrayOutputStream.toByteArray();
        String base64Encoded = Base64.encodeToString(byteArray, Base64.NO_WRAP);
        setImgBase64(base64Encoded);
//        Log.i(TAG, "BASE 64 : "+ getImgBase64());
        String message;
        if(getImgBase64() == ""){
            message = "ERROR";
        }
                        ...
                        if (detectionResults.getDetectedItems() != null &&
                            ...
                            for (int i = 0; i < detectionResults.getDetectedItems().size(); i++) {
                                ...
                                if (detectionResults.getDetectedItems().get(key) != null &&
                                    ...
                                    float mouth = mFace.getIsSmilingProbability();

                                    if ((contains(face.getLandmarks(), 11) != 99) && (contains(face.getLandmarks(), 5) != 99) && (contains(face.getLandmarks(), 6) != 99)){
                                        cBottomMouthX = (face.getLandmarks().get(contains(face.getLandmarks(), 0)).getPosition().x);
                                        cBottomMouthY = (face.getLandmarks().get(contains(face.getLandmarks(), 0)).getPosition().y);
                                        Log.i(TAG, "draw: Condition Bottom mouth >> cBottomMouthX >> " + cBottomMouthX + "    cBottomMouthY >> " + cBottomMouthY);
                                    }
                                    if ((contains(face.getLandmarks(), 11) != 99) && (contains(face.getLandmarks(), 5) != 99) && (contains(face.getLandmarks(), 6) != 99)){
                                        cLeftMouthX = (face.getLandmarks().get(contains(face.getLandmarks(), 5)).getPosition().x);
                                        cLeftMouthY = (face.getLandmarks().get(contains(face.getLandmarks(), 5)).getPosition().y);
                                        Log.i(TAG, "draw: Condition LEft mouth >> cLeftMouthX >> " + cLeftMouthX + "    cLeftMouthY >> " + cLeftMouthY);
                                    }
                                    if ((contains(face.getLandmarks(), 11) != 99) && (contains(face.getLandmarks(), 5) != 99) && (contains(face.getLandmarks(), 6) != 99)){
                                        cRightMouthX = (face.getLandmarks().get(contains(face.getLandmarks(), 11)).getPosition().x);
                                        cRightMouthY = (face.getLandmarks().get(contains(face.getLandmarks(), 11)).getPosition().y);
                                    ...
                                    MOUTH_IS_OPEN = differenceY;
                                    Log.i(TAG, "DIFFERENT : " + centerPointY +" , "+ cBottomMouthY);
                                    Log.i(TAG, "RESULT : "+ differenceY);

                                    if ((left == Face.UNCOMPUTED_PROBABILITY) || (right == Face.UNCOMPUTED_PROBABILITY) || (mouth == Face.UNCOMPUTED_PROBABILITY)) {
                                    ...
                                    switch (state) {
                                        ...
                                        case 3:
                                            txtBlinkEye.setText("Buka Mulut");
                                            if ((MOUTH_IS_OPEN > -60)) {
                                                // Initial Mouth
                                                android.util.Log.d(TAG, "INITIAL MOUTH :"+MOUTH_IS_OPEN);
                                                state = 4;
                                                inCircle = false;
                                            }
                                            else{
                                                android.util.Log.d(TAG, "RETAKE");
                                                state = 3;
                                                inCircle = false;
                                            }
                                            break;
                                        ...
                                        case 4:
                                            if ((MOUTH_IS_OPEN < -60)) {
                                                // Open Mouth
                                                android.util.Log.d(TAG, "RESULT MOUTH :"+MOUTH_IS_OPEN);
                                                state = 5;
                                                inCircle = false;
                                            }
                                            break;
                                        ...
                                        case 5:
                                            txtBlinkEye.setText("Tutup Mulut dan Senyum");
                                            if ((mouth < OPEN_MOUTH)) {
                                                // Initial Mouth
                                                state = 6;
                                                inCircle = false;
